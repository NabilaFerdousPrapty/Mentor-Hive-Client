    ...
    <div className="md:mt-20 mx-auto">
      <div className="md:flex justify-evenly items-center">
        ...
        <div className="flex-1 space-y-5">
          <h1 className="text-3xl text-center font-bold text-[#3b478f]">
            Why Choose Us!
          </h1>
          ...
          <div className="flex justify-evenly items-center">
            <h1>
              <span className="font-bold text-5xl text-[#3b478f]">3000+</span>{" "}
              <br /> <span className="font-bold">Authentic Tuitions</span>{" "}
            </h1>
            <h1>
              <span className="font-bold text-5xl text-[#3b478f]">130+</span>{" "}
              <br /> <span className="font-bold">Verified Tutor</span>{" "}
            </h1>
            <h1>
              <span className="font-bold text-5xl text-[#3b478f]">10000+</span>{" "}
